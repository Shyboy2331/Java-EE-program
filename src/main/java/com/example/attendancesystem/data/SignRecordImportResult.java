...
@AllArgsConstructor
@NoArgsConstructor
public class SignRecordImportResult {
    /**
     * 是否全部成功
     */
     ...
     * 成功导入的打卡记录列表
     */
    private List<SignRecord> successRecords = new ArrayList<>();
    
    /**
     * 失败记录列表
     */
    private List<SignRecordImportError> failRecords = new ArrayList<>();
     ...
     * 添加成功记录
     */
    public void addSuccessRecord(SignRecord record) {
     ...
     * 添加失败记录
     */
    public void addFailRecord(SignRecordImportError errorRecord) {
